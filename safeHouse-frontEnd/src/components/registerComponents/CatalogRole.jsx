    ...
    return (
        <>
            <div className='grid grid-cols-3 sm:mx-12 items-center m-4 sm:m-10'> {/* query */}
                ...
                <select name='role' required value={inputValue} onChange={inputOnchange} className='col-span-2 p-1 shadow-md  bg-input-color rounded-md text-xs sm:text-xl h-6 sm:h-10 w-5/12'> {/* query */}
