...
const MenuRequest = () => {
    ...
    return (
        <div>
            ...
            <div onClick={handleEvent} className='w-full relative flex flex-col justify-center pr-4 sm:pr-8 pb-2 items-end cursor-pointer group/item'>
                <ul className={`absolute right-7 sm:right-11  top-7 mt-2 p-1 rounded-lg bg-slate-100 shadow-lg ${state ? 'opacity-100 scale-100' : 'opacity-0 scale-95'} z-50`}>
